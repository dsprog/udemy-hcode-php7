            ...
            <div class="col-md-8">
                <div class="user-menu">
                    <ul>
                        ...
                        <li>
                            <a href="#"
                                ><i class="fa fa-shopping-cart"></i> Meu
                                Carrinho</a
                            >
                        </li>
                        <li>
...
<div class="slider-area">
    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            <li>
                <img src="assets/site/img/h4-slide.png" alt="Slide" />
            ...
            <li>
                <img src="assets/site/img/h4-slide2.png" alt="Slide" />
                <div class="caption-group">
                    <h2 class="caption title">
                        by one, get one
            ...
            <li>
                <img src="assets/site/img/h4-slide3.png" alt="Slide" />
                <div class="caption-group">
                    <h2 class="caption title">
                        Apple
            ...
            <li>
                <img src="assets/site/img/h4-slide4.png" alt="Slide" />
                <div class="caption-group">
                    <h2 class="caption title">
                        Apple
                        <span class="primary">Store <strong>Ipod</strong></span>
                    ...
                    <div class="product-carousel">
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="assets/site/img/product-1.jpg" alt="" />
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="assets/site/img/product-2.jpg" alt="" />
                                <div class="product-hover">
                                    <a href="#" class="add-to-cart-link"
                                        ><i class="fa fa-shopping-cart"></i> Add
                                        to cart</a
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="assets/site/img/product-3.jpg" alt="" />
                                <div class="product-hover">
                                    <a href="#" class="add-to-cart-link"
                                        ><i class="fa fa-shopping-cart"></i> Add
                                        to cart</a
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="assets/site/img/product-4.jpg" alt="" />
                                <div class="product-hover">
                                    <a href="#" class="add-to-cart-link"
                                        ><i class="fa fa-shopping-cart"></i> Add
                                        to cart</a
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="assets/site/img/product-5.jpg" alt="" />
                                <div class="product-hover">
                                    <a href="#" class="add-to-cart-link"
                                        ><i class="fa fa-shopping-cart"></i> Add
                                        to cart</a
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                <img src="assets/site/img/product-6.jpg" alt="" />
                                <div class="product-hover">
                                    <a href="#" class="add-to-cart-link"
                                        ><i class="fa fa-shopping-cart"></i> Add
                                        to cart</a
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="footer-about-us">
                    ...
                    <p>
                        ...
                        elit. Perferendis sunt id doloribus vero quam laborum
                        quas alias dolores blanditiis iusto consequatur, modi
                        aliquid eveniet eligendi iure eaque ipsam iste, pariatur
                        omnis sint! Suscipit, debitis, quisquam. Laborum commodi
                        veritatis magni at?
                    </p>
                    <div class="footer-social">
                        <a
                            href="https://www.facebook.com/hcodebr"
                            target="_blank"
                        ...
                        ></a>
                        <a
                            href="https://www.youtube.com/channel/UCjWENuSH2gX55-y7QSZiWxA"
                            target="_blank"
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-newsletter">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Perferendis sunt id doloribus!
                    </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>
                        &copy; 2017 Hcode Treinamentos.
                        <a href="http://www.hcode.com.br" target="_blank"
                            >hcode.com.br</a
                        >
                    </p>
                </div>
